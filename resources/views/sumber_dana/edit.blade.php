...
@section('title', 'Edit Jenis Penerimaan Dana')
...
<div class="page-header">
    <div class="d-flex align-items-center">
        ...
        <div>
            <h2 class="mb-1 fw-bold">Edit Jenis Penerimaan Dana</h2>
            <p class="mb-0 opacity-75">Perbarui informasi jenis penerimaan dana</p>
        </div>
    </div>
</div>
            ...
            <div class="mb-3">
                ...
                <div class="input-icon">
                    ...
                    <input type="text" 
                           ...
                           value="{{ old('id_sumber_dana', $sumber_dana->id_sumber_dana) }}"
                           required>
                </div>
            ...
            <div class="mb-0">
                ...
                <div class="input-icon">
                    ...
                    <input type="text" 
                           ...
                           value="{{ old('nama_sumber_dana', $sumber_dana->nama_sumber_dana) }}"
                           required>
                </div>
