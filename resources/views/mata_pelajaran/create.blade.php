...
<div class="page-header">
    <div class="d-flex align-items-center">
        ...
        <div>
            <h2 class="mb-1 fw-bold">Tambah Mata Pelajaran</h2>
            <p class="mb-0 opacity-75">Tambahkan mata pelajaran baru ke sistem</p>
        </div>
    </div>
</div>
    ...
    <form action="{{ route('mata_pelajaran.store') }}" method="POST">
        ...
        <div class="form-section">
            ...
            <div class="info-box">
                ...
                <strong>Tips:</strong>
                <p>Jumlah jam adalah total jam pelajaran per minggu untuk mata pelajaran ini.</p>
            </div>
        </div>
