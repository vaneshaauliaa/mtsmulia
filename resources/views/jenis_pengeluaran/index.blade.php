...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h2 class="mb-1 fw-bold">💸 Jenis Pengeluaran Dana</h2>
            <p class="mb-0 opacity-75">Kelola jenis pengeluaran dana</p>
        </div>
        <a href="{{ route('jenis_pengeluaran.create') }}" class="btn btn-add">
    ...
    <table class="table table-modern align-middle mb-0">
        <thead>
            <tr class="text-center">
                <th width="10%">No</th>
                <th width="25%">Kode</th>
                <th width="45%">Nama Jenis Pengeluaran Dana</th>
                <th width="20%">Aksi</th>
            </tr>
        </thead>
        <tbody>
            @php $no = 1; @endphp
            @forelse($jenis_pengeluaran as $item)
            <tr class="text-center">
                <td>
                    <span class="no-cell">{{ $no++ }}</span>
                </td>
                <td>
                    <span class="code-badge">{{ $item->id_jenis_pengeluaran }}</span>
                </td>
                <td class="text-start">
                ...
                <td>
                    <div class="btn-action-group">
                        <a href="{{ route('jenis_pengeluaran.edit', $item->id) }}" 
            ...
            <tr>
                <td colspan="4" class="empty-state">
                    ...
                    <p class="mb-0">Belum ada data jenis pengeluaran dana</p>
