...
@section('title', 'Laporan Dana Masuk')
...
<div class="report-container">
    ...
    <div class="report-header">
        ...
        <div class="report-title">Laporan Dana Masuk</div>
    ...
    <div class="filter-section no-print">
        ...
        <form method="GET" action="{{ route('laporan.kas_masuk') }}">
            <div class="row g-3">
                <div class="col-md-4">
            ...
            <tbody>
                @forelse ($kasMasuk as $item)
                    <tr>
                        ...
                        <td>
                            <i class="bi bi-calendar3 me-1" style="color: #8B4513;"></i>
                            {{ \Carbon\Carbon::parse($item->tanggal)->translatedFormat('d F Y') }}
                        </td>
                        <td>{{ $item->keterangan }}</td>
                        <td>
                            <span class="sumber-badge">
