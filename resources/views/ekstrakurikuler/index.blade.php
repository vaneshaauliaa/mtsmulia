...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h2 class="mb-1 fw-bold">🎯 Data Ekstrakurikuler</h2>
            <p class="mb-0 opacity-75">Kelola daftar ekstrakurikuler sekolah</p>
        </div>
        <a href="{{ route('ekstrakurikuler.create') }}" class="btn btn-add">
...
<div class="search-box">
    ...
    <input type="text" 
           id="searchInput" 
           placeholder="Cari berdasarkan kode atau nama ekstrakurikuler...">
</div>

{{-- TABLE --}}
<div class="table-container">
    <table class="table table-modern align-middle mb-0" id="ekskulTable">
        <thead>
            <tr class="text-center">
                <th width="10%">No</th>
                <th width="25%">Kode Ekstrakurikuler</th>
                <th width="45%">Nama Ekstrakurikuler</th>
                <th width="20%">Aksi</th>
            </tr>
        </thead>
        <tbody id="tableBody">
            ...
            <tr class="text-center">
                ...
                <td>
                    <span class="code-badge">{{ $item->id_ekstrakurikuler }}</span>
                </td>
                <td class="text-start">
                    <span class="ekskul-name">
                        <i class="bi bi-trophy-fill me-2" style="color: #8B4513;"></i>
                        {{ $item->nama_ekstrakurikuler }}
                    </span>
                </td>
                <td>
                    <a href="{{ route('ekstrakurikuler.edit', $item->id) }}" class="btn btn-edit btn-action">
                        <i class="bi bi-pencil-square"></i> Edit
                    </a>
                    <form action="{{ route('ekstrakurikuler.destroy', $item->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
                        @csrf
                        @method('DELETE')
            ...
            <tr>
                <td colspan="4" class="empty-state">
                    ...
                    <small class="text-muted">Mulai dengan menambahkan ekstrakurikuler pertama</small>
                </td>
            </tr>
            @endforelse
        </tbody>
