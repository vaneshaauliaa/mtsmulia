...
<div class="page-header">
    <div class="d-flex align-items-center">
        ...
        <div>
            <h2 class="mb-1 fw-bold">✏️ Edit Jabatan</h2>
            <p class="mb-0 opacity-75">Perbarui informasi jabatan</p>
        </div>
    </div>
</div>
            ...
            <div class="mb-4">
                ...
                <div class="input-group">
                    ...
                    <input type="number" 
                           ...
                           id="honor_jabatan" 
                           name="honor_jabatan" 
                           value="{{ old('honor_jabatan', $jabatan->honor_jabatan) }}"
